        ...
        <>
            <div className="flex items-center justify-center min-h-screen bg-gray-100">
                <div className="w-5/12">
                    <div className="bg-white transform -rotate-3 hover:rotate-0 transition-all duration-300 hover:shadow-md shadow-xl rounded-lg overflow-hidden">
                        <div className="px-8 py-5 leading-relaxed text-xl text-gray-800">
                            <svg width="45" height="36" className="mb-5 fill-current text-cyan-100"><path d="M13.415.001C6.07 5.185.887 13.681.887 23.041c0 7.632 4.608 12.096 9.936 12.096 5.04 0 8.784-4.032 8.784-8.784 0-4.752-3.312-8.208-7.632-8.208-.864 0-2.016.144-2.304.288.72-4.896 5.328-10.656 9.936-13.536L13.415.001zm24.768 0c-7.2 5.184-12.384 13.68-12.384 23.04 0 7.632 4.608 12.096 9.936 12.096 4.896 0 8.784-4.032 8.784-8.784 0-4.752-3.456-8.208-7.776-8.208-.864 0-1.872.144-2.16.288.72-4.896 5.184-10.656 9.792-13.536L38.183.001z"></path></svg>
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempora, quae? Eligendi reprehenderit quod non amet quasi consectetur debitis ipsa exercitationem?
                        </div>
                        <div className="px-8 py-5 bg-gradient-to-r from-yellow-500 via-red-500 to-pink-500 flex items-center justify-between">
                            <div className="flex items-center">
                                <div className="flex-shrink-0 mr-3">
                                    <img className="w-10 h-10 rounded-full border-2 border-white" src="/logo.jpg"/>
                                </div>
                            ...
                            <a href="#" className="text-white text-opacity-50 hover:text-opacity-75 transition-all duration-150">
