        ...
        <>
            <div className="flex items-center justify-center min-h-screen bg-gray-100">
                <div className="w-5/12">
                    <div className="bg-white transform -rotate-3 hover:rotate-0 transition duration-300 hover:shadow-md shadow-xl rounded-lg overflow-hidden">
                        ...
                        <div className="px-8 py-5 bg-gradient-to-r from-yellow-500 via-red-500 to-pink-500 flex items-center justify-between">
                            ...
                            <a href="#" className="text-white text-opacity-50 hover:text-opacity-75 transition duration-150">
